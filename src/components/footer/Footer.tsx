    ...
    <footer className="w-full lg:px-[1rem]">
      <div className="w-full px-4 md:px-[1.5rem]  lg:px-[4rem] py-6 flex flex-col justify-center items-center gap-3 bg-gray-500 bg-opacity-30 backdrop-blur-md rounded-t-xl shadow-lg">
        <div className="flex items-center justify-between w-full">
          <div className="w-full md:max-w-[20rem] text-start flex flex-col gap-2 text-[#eee]">
          ...
          <div className="w-full h-auto flex flex-col md:flex-row md:justify-between py-5 gap-4 ">
            <div className=" w-full grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col items-start gap-1 text-start">
                ...
                <ul className="grid grid-cols-2 gap-y-2 w-full text-gray-300">
                  <li>
                    <Link to="/">Home</Link>
                  </li>
                  <li>
              ...
              <div className="flex flex-col items-start gap-1 text-left">
                ...
                <ul className="flex flex-col gap-y-3 w-full text-gray-300">
                  <li>
        ...
        <div className="flex items-center justify-between w-full gap-4">
          <p className="text-xs md:text-sm lg:text-lg text-gray-300 min-w-[12.7rem] text-left">
