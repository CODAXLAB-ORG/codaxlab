  ...
  return (
    <Html wrapperClass="!transform-none" prepend>
      <div className="w-screen h-screen fixed inset-0 pointer-events-none z-[5000000]">
        <span
          ref={ref}
          className="size-6 border-[1px] backdrop-blur-md scale border-black bg-black/20 invert mix-blend-difference duration-100 rounded-full block absolute left-0 top-0 pointer-events-none"
        />
      </div>
    </Html>
  );
